...
///-------------------------------------------------------------------
/// saveTokenOnDevices
/// save Tokens on SharedPreferences device
///
/// Author: Rai Junior
/// Jun/2023
///-------------------------------------------------------------------
/// CCB Brasil  - Copyrights
///-------------------------------------------------------------------
Future<bool> saveTokensOnDevices(String json) async {
  /// Mock
  /// sample json
  /// persons.add(DeviceToken(
  ///         token: "PEhedStqb6X1xBM3VfM2iXs99Vdk3G",
  ///         usuario: "Hari Prasad Chaudhary",
  ///         ativo: 0));
  /// persons.add(DeviceToken(
  ///         token: "QEhedStqb6X1xBM3VfM2iXs99Vdk3G",
  ///         usuario: "Krishna Karki",
  ///         ativo: 0));
  /// persons.add(DeviceToken(
  ///         token: "REhedStqb6X1xBM3VfM2iXs99Vdk3G",
  ///         usuario: "Ujjwal Joshi",
  ///         ativo: 0));
  /// persons.add(DeviceToken(
  ///         token: "SEhedStqb6X1xBM3VfM2iXs99Vdk3G",
  ///         usuario: "Samir Hussain Khan",
  ///         ativo: 0));
...
Future<bool> fetchVirtualToken(QrCodeData? code) async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      //saveTokensOnDevices(jsonDecode(response.body));
      // mock
...
class _QRViewCCBState extends State<QRViewCCB> {
  ...
  void _fetchData(BuildContext context, String? code) async {
    ...
    try {
      ...
      meuRetorno = await saveTokensOnDevices(code);
    } on Exception catch (e) {
