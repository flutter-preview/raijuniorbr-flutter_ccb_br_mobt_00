...
class SetupFlowState extends State<SetupFlow> {
  ...
  void _onDiscoveryComplete() {
    _navigatorKey.currentState!.pushNamed(globals.routeDeviceSetupSelectDevicePage);
  }

  void _onDeviceSelected(String deviceId) {
    _navigatorKey.currentState!.pushNamed(globals.routeDeviceSetupConnectingPage);
  }
