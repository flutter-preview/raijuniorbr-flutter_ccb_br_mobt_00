...
class _TokenGeneratorState extends State<TokenGenerator> with TickerProviderStateMixin {
  late AnimationController controller;
  //final totp = Totp.fromBase32(secret: 'GEZDGNBVGY3TQOJQGEZDGNBVGY3TQOJQ', digits: 6, period: 60);
  final totp = Totp(secret: 'PEhedStqb6X1xBM3VfM2iXs99Vdk3G'.codeUnits, digits: 6, period: globals.tokenPeriod - 2);
 ...
 */
                                      Text(
                                        _getToken(0),
                                        style: const TextStyle(fontSize: 76.0, color: Colors.black),
                                      ),
                                    ],
                                  ),
                                ),
                          ...
                          builder: (context, child) {
                            return ElevatedButton(
                              ...
                              child: Column(children: [
                                ...
                                Text(controller.isAnimating ? "Parar" : "Gerar",
